...
var printGraph = function printGraph(graph) {
  var myGraph = graph;
  myGraph['children'] = graph['children'].map(function (d) {
    var _cyEle = d._cyEle,
      ele = _objectWithoutProperties(d, _excluded);
    return ele;
  });
  myGraph['edges'] = graph['edges'].map(function (d) {
    var _cyEle = d._cyEle,
      ele = _objectWithoutProperties(d, _excluded2);
    return ele;
  });
